...
query_source = ("SELECT * FROM radioa26_radioad.vendors") #runn query to select all records on vendors table
...
for i in cursor_source:
  user_list.append(('1234',True,hash_str,i[3],datetime.datetime.now()))
  usergroup_list.append((k,2,datetime.datetime.now()))
  broadcaster_list.append((i[9],"nigeria",i[2],i[4],k,"","","","","","","","","",datetime.datetime.now()))
  k+=1
